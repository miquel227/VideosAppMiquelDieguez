<x-videos-app-layout>
    <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Eliminar usuari</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6" data-qa="delete-confirm-box">
            ...
            <div class="flex items-start gap-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Estàs a punt d'eliminar l'usuari
                        <strong class="text-gray-800" data-qa="user-name">{{ $user->name }}</strong>
                        ({{ $user->email }}).
            ...
            <div class="flex justify-end gap-3">
                ...
                <form method="POST" action="{{ route('users.manage.destroy', $user) }}">
                    @csrf
                    @method('DELETE')
                    <button
                        type="submit"
